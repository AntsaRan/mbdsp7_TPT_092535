...
import com.example.bet.model.MatchRegle;
...
public class Match_Details extends AppCompatActivity {
    ...
    Utilisateur_Service serviceUtil;
    /////
                    ...
                    if(testMise(nbr_mise.getText().toString())){
                        ...
                        insertPari(utilisateur.getId(),idMatch,idMatchRegle,Float.valueOf(nbr_mise.getText().toString())).enqueue(new Callback<ResponseBody>() {
                            ...
                            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                ...
                                callGetUserById(utilisateur.getId()).enqueue(new Callback<Utilisateur>() {
                                    @Override
                                    public void onResponse(Call<Utilisateur> call2, Response<Utilisateur> response2) {
                                        Utilisateur results = fetchUtilisateur(response2);
    ...
    public void CheckUser(){
        if(NetworkUtils.networkStatus(this)){
            callGetUserById(utilisateur.getId()).enqueue(new Callback<Utilisateur>() {
                @Override
                public void onResponse(Call<Utilisateur> call2, Response<Utilisateur> response2) {
                    Utilisateur results = fetchUtilisateur(response2);
